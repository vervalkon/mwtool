#WARNING GITHUB PEOPLE: THIS CODE IS DOGSHIT!!!!!!!!
#DO NOT USE IN THE ANALYTIC SENSE, ONLY RUN ONCE AND GET YOUR OUTPUT IF NEED BE
#I'M WORKING ON A MUCH MORE ELEGANT IMPLEMENTATION
